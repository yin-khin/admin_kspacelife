...
//   // Already HTML → return as-is (no double convert)
...
//   // Single newlines  → <br> inside same <p>
...
//     setLoading(true);
//     try {
//       // ✅ Convert textarea plain text → HTML before saving
...
//     // ✅ Convert stored HTML back to plain text so textarea shows \n correctly
...
//           background: #f8fafc; color: #1e293b; font-family: monospace;
//         }
//       `}</style>
...
//                 {/* ✅ Content textarea — Enter key works naturally */}
...
//                           <div className="px-3 py-2 bg-slate-50 text-xs text-slate-500 border-t border-slate-100">
//                             📝 {selectedPost.image_descriptions[i]}
//                           </div>
//                         )}
//                       </div>
...
//                 {/* ✅ Content display with correct line breaks */}
//                 <div
